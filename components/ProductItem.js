...
const ProductItem = ({ article }) => {
  ...
  let linkQueryAs = categories.sideCategory
    ? `/${categories.mainCategory}/${categories.sideCategory}/${
        article[cellNames.ID]
      }`
    : `/${categories.mainCategory}/${article[cellNames.ID]}`;
